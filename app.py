...
def legal_reason_cases(issue, result):
    # After reading the results, which two cases do you think are the most relevant to the legal issue? if cannot decide, discard (assume bad search results / no such legal rule)
